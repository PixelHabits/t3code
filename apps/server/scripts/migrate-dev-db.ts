...
export interface RunMigrateDevDbInput {
  ...
  /** Source database. Defaults to `<default T3 home>/userdata/state.sqlite`. */
...
export const migrateDevDbCommand = Command.make(
  "migrate-dev-db",
  {
    ...
    source: Flag.string("source").pipe(
      Flag.optional,
      Flag.withDescription("Source database. Defaults to <default T3 home>/userdata/state.sqlite."),
    ),
  },
